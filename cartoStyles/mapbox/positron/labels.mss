...
//base colors
@label_foreground: #8494a1;
@label_foreground_halo: rgba(236,236,234,0.7);

@label_background: #b6b6b6;
@label_background_halo: rgba(255,255,255,0.7);

//ocean/sea labels
@marine_labels: #fff;
@marine_labels_halo: lighten(@label_foreground,10%);
...
@admin1_labels_halo: rgba(255,255,255,1);
@admin1_labels: #62717E;//rgba(47,48,53,0.8);

//city labels low zooms
@label_lowzoom_shield_fill: lighten(@label_foreground, 7%);
@label_shield_halo: lighten(@label_foreground_halo,10%);

@city_shield: url(positron/images/city_shield_light.svg);
@capital_shield: url(positron/images/capital_shield_light.svg);

//city labels high zoom
@city_label_highzoom: lighten(@label_foreground,15%);
@city_label_halo_highzoom: lighten(@label_foreground_halo,10%);
@city_label_medium: lighten(@label_foreground,5%);
@city_label_large: darken(@label_foreground,5%);

//Lake and River Labels
@water_label: lighten(#6b8a95, 5%);
@water_halo: lighten(#e3e3dc, 8%);
...
//park labels
@park_label_fill: darken(#d4ded6, 30%);
@park_label_halo: lighten(#e3e3dc, 8%);
