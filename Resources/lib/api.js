function createApi(_context) {
    ...
    var api = new _context.MicroEvent({
        ...
        chainCalls: function(_calls, _callback) {
            return new CallChain(_calls, _callback);
        },
        call: function(options) {
            if (api.networkConnected === false) {
                onError('no network connection', options.onError, options);
                return;
            }
            if (api.offlineMode === true) {
                options.silent = true;
                onError('offline mode', options.onError, options);
                return;
            }
            ...
            var client = new HTTPClient({
                ...
                onload: function(e) {
                    ...
                    if (options.onData) {
                        ...
                        onSuccess(this, e, options.onSuccess, options.onError, options);
                    }
                },
                onerror: function(e) {
                    var returnText = this.responseText;
                    sdebug('onerror', returnText);
                    if (returnText) {
                        var jsonResponse;
                        try {
        ...
        queryImages: function(_query, res, chain) {
            var params = _.assign({
            ...
            return api.call({
                ...
                onSuccess: function(_result) {
                    res = res || {};
                    res.photos = _result.photos.photo;
                    chain.next(res);
                },
                onError: chain.error
            });
        },
        queryGeoFeatures: function(_query, _region, _feature, _itemHandler, _callback) {
            var data = '';
            if (_region) {
            ...
            return api.call({
                ...
                onSuccess: function(result) {
                    ...
                    if (_feature.usingWays) {
                        ...
                        _callback({
                            result: _.mapIfDefined(resultingWays, function(way, key) {
                        ...
                        _callback({
                            result: _.mapIfDefined(result.elements, function(ele) {
        ...
        addressAutocomplete: function(_query, _callback) {
        ...
        reverseGeocode: function(_query, _callback) {
            ...
            return api.call({
                ...
                onSuccess: function(e, _options) {
                    if (e.error) {
                        onError(e.error, _callback, _options);
                        return;
                    } else if (!e.display_name) {
                        onError(trc('no_result_found'), _callback, _options);
                        return;
                    }
                    if (_callback) {
                        _callback(convert.osmAddress(e));
                    }
                },
                onError: _callback
            });
        },
        queryDirections: function(_args, _callback) {
            return api.call({
                ...
                onSuccess: function(result, _options) {
                    ...
                    if (result.routes.length === 0) {
                        onError(trc('no_route_found'), _callback, _options);
                        return;
                    }
        ...
        osmDetails: function(_args, res, chain) {
            if (!_args.osm) {
                chain.next(res);
                return;
            }
        ...
        osmAddress: function(_args, res, chain) {
            sdebug('osmAddress', _args);
            if (!_args.osm) {
                onError(trc('no_result_found'), chain.error);
                return;
            }
            return api.call({
                ...
                onSuccess: function(result, _options) {
                    ...
                    res = res || {};
                    if (result.length > 0) {
                        res.address = convert.osmAddress(result[0]);
                    }
                    chain.next(res);
                },
                onError: chain.error
        ...
        searchOSM: function(_params, res, chain) {
            var region;
            if (_params.region) {
        ...
        //search around algo
        searchOSM2: function(_params, _callback) {
            ...
            return api.call({
                ...
                onSuccess: function(result, _options) {
                    ...
                    _callback(_.sortBy(results, 'distance'));
                    // }
                },
                onError: _callback
            });
        },
        queryTraffic: function(_bbox, _callback) {
            ...
            return api.call({
                ...
                onSuccess: function(result) {
                    if (_callback) {
                        _callback(result, points);
                    }
                }
            });
        },
        queryPanoramas: function(_params, _feature, _itemHandler, _callback) {
        ...
        //     });
        // },
        mapquestDirection: function(_args, _callback) {
            var params = {
                key: app.servicesKeys.mapquest,
                inFormat: 'json',
                outFormat: 'json',
        ...
        mapquestElevation: function(_point, _callback) {
            var params = {
                key: app.servicesKeys.mapquest,
                inFormat: 'json',
                outFormat: 'json',
        ...
        ignElevation: function(_point, _callback) {
            var params = {
                // zonly: true,
                lat: _point.latitude,
        ...
        ignElevationProfile: function(_itemHandler, _points, _callback) {
        ...
        mapquestElevationProfile: function(_points, _callback) {
            var params = {
                key: app.servicesKeys.mapquest,
                inFormat: 'json',
                outFormat: 'json',
        ...
        gPlaceSearch: function(_params, _callback) {
            ...
            return api.call({
                ...
                onSuccess: function(result, _options) {
                    if (result.results.length === 0) {
                        onError(trc('no_place_found'), _callback, _options);
                        return;
                    }

                    if (_callback) {
                        _callback(_.reduce(result.results, function(memo, value) {
        ...
        gPlaceDetails: function(_placeiid, _callback) {
        ...
        downloadAndSaveImage: function(_url, _imageId, _callback) {
            return api.call({
                ...
                onData: function(e) {
                    ...
                    Ti.Filesystem.getFile(app.getImagePath(path)).write(e.responseData);
                    _callback({
                        image: e.responseData,
                        imageName: path
                    });
                },
                onError: _callback
        ...
        getImage: function(_source, res, chain) {
            ...
            return api.call({
                ...
                onData: function(e) {
                    ...
                    result.image = e.responseData;
                    result.url = url;
                    res.images.push(result);
                    // res.image = e.responseData;
                    // res.imageLink = _source;
                    chain.next(res);
                },
                onError: chain.error
            });
        },
        getPhoto: function(_photo, res, chain) {
            sdebug('getPhoto', _photo);
            var url = _photo.url;
            var imageId = moment().valueOf();
            api.downloadAndSaveImage(url, imageId, function(e) {
                if (e.image) {
                    ...
                    res.photos.push(result);
                    if (result.thumbnail) {
                        api.downloadAndSaveImage(result.thumbnail, imageId + '_thumb', function(e2) {
                            if (e2.image) {
            ...
            //             imageName)).write(image);
            //         result.newPhotos.push(theImg);
            //         result.url = url;

            //         res.photos.push(result);
            //         if (result.thumbnail) {
            //             api.downloadImage(result.thumbnail, function(e) {
            //                 if (e.image) {
        ...
        openWeatherMapLatLng: function(_params, _callback) {
        ...
        openWeatherForecast: function(_params, _callback) {
            var coord = geolib.coords(_params);
        ...
        openWeatherMapRegion: function(_params, _callback) {
                ...
                onSuccess: function(result, _options) {
                    ...
                    if (result.list) {
                        if (result.list.length > 0) {
                            ...
                            api.openWeatherMapLatLng(geolib.getCenter([region.sw, region.ne]),
                                _callback);
                        }
                    } else {
                        _callback(result);
        ...
        photonSearch: function(_params, _callback) {
            ...
            return api.call({
                ...
                //     // }
                // },
                onSuccess: function(results, _options) {
