...
class RowTemplates extends TemplateModule {
    ...
    constructor() {
        ...
        let toAdd = {
            ...
            list: {
                properties: {
                    rclass: 'ListRow',
                    rightSwipeButtons: [
                        this.createSwipeButton('clear', 'blue'),
                        this.createSwipeButton('delete', 'red'),
                    ],
                    leftSwipeButtons: [
                        this.createSwipeButton('edit', 'green')
                    ]
                },
                childTemplates: [{
                    type: 'Ti.UI.Label',
        ...
        this.listitem = this.cloneTemplateAndFill(
            'iteminfo', {
                properties: {
                    rightSwipeButtons: [
                        this.createSwipeButton('delete', 'red'),
                    ...
                    leftSwipeButtons: [
                        this.createSwipeButton('locate', 'blue'),
                        this.createSwipeButton('move', 'green'),
                    ]
                }
            });
        this.gfoptionfileitem = this.cloneTemplateAndFill(
            'gfoptionitem', {
                properties: {
                    rightSwipeButtons: [
                        this.createSwipeButton('delete', 'red'),
