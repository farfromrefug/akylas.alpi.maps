...
if (!AR.build.mobile) {
            ...
            switch (b) {
                ...
                case AR.ERROR.TYPE.ENUMERATION:
                    c = AR.ERROR.ERROR_PREFIX + d +
                        " is not one of the allowed values defined in the 'enumeration-object' " + e +
                        buildStack("<br />");
                    break;
                ...
                case AR.ERROR.TYPE.ARRAY_CONTENT:
                    c = AR.ERROR.ERROR_PREFIX + d + " contains invalid values in the array." + buildStack(
                        "<br />");
                    break;
                case AR.ERROR.TYPE.OBJECT:
                    c = AR.ERROR.ERROR_PREFIX + d + " of object type " + a +
                        " is not of the expected object type " + e + buildStack("<br />");
                    break;
    ...
    AR.js.clickBehavior = {
        ...
        executeClick: function(a) {
            if (a.target === document.body || a.target === document.documentElement || (a.target.style.background ==
                    "none" && typeof(a.target.attributes["data-role"]) !== "undefined" && a.target.attributes[
                        "data-role"].value === "page")) {
    ...
    AR.js.clickBehavior.removeClickBehavior = function() {
        if (AR.js.clickBehavior.currentBehavior != null) {
            if (AR.js.clickBehavior.currentBehavior.touchstartEvent != null) {
                document.removeEventListener("touchstart", AR.js.clickBehavior.currentBehavior.touchstartEvent,
                    true)
            }
        ...
        init: function(d) {
            ...
            if (d) {
                if (d.enabled != undefined) {
                    a = _PROPERTY_VALIDATOR.validate("enabled", d.enabled, _PROPERTY_VALIDATOR.TYPE.BOOLEAN,
                        _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)
                }
                if (d.triggers) {
                    if (d.triggers.onEnterFieldOfVision) {
                        c = _PROPERTY_VALIDATOR.validate("triggers.onEnterFieldOfVision", d.triggers.onEnterFieldOfVision,
                            _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                    }
                    if (d.triggers.onExitFieldOfVision) {
                        g = _PROPERTY_VALIDATOR.validate("triggers.onExitFieldOfVision", d.triggers.onExitFieldOfVision,
                            _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                    }
                }
                if (d.onEnterFieldOfVision) {
                    c = _PROPERTY_VALIDATOR.validate("onEnterFieldOfVision", d.onEnterFieldOfVision,
                        _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (d.onExitFieldOfVision) {
                    g = _PROPERTY_VALIDATOR.validate("onExitFieldOfVision", d.onExitFieldOfVision,
                        _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (d.onClick) {
                    e = _PROPERTY_VALIDATOR.validate("onClick", d.onClick, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                b = new AR.ARObjectDrawables(this, d.drawables);
                if (d.renderingOrder) {
                    f = _PROPERTY_VALIDATOR.validate("renderingOrder", d.renderingOrder,
                        _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)
                }
            } else {
            ...
            this.__defineSetter__("enabled", function(h) {
                h = _PROPERTY_VALIDATOR.validate("enabled", h, _PROPERTY_VALIDATOR.TYPE.BOOLEAN,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                AR.i.callAsync({
                    objectId: this.__id,
                    enabled: h,
            ...
            this.__defineSetter__("renderingOrder", function(h) {
                h = _PROPERTY_VALIDATOR.validate("renderingOrder", h, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                AR.i.callAsync({
                    objectId: this.__id,
                    renderingOrder: h,
            ...
            this.__defineSetter__("onEnterFieldOfVision", function(h) {
                h = _PROPERTY_VALIDATOR.validate("onEnterFieldOfVision", h, _PROPERTY_VALIDATOR.TYPE
                    .FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                c = h;
                AR.i.callAsync({
                    objectId: this.__id,
            ...
            this.__defineSetter__("onExitFieldOfVision", function(h) {
                h = _PROPERTY_VALIDATOR.validate("onExitFieldOfVision", h, _PROPERTY_VALIDATOR.TYPE
                    .FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                g = h;
                AR.i.callAsync({
                    objectId: this.__id,
            ...
            this.__defineSetter__("onClick", function(h) {
                h = _PROPERTY_VALIDATOR.validate("onClick", h, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                e = h;
                AR.i.callAsync({
                    objectId: this.__id,
    ...
    AR.Drawable = AR.ARchitectObject.extend({
        init: function(b) {
            ...
            var d = null;
            if (b) {
                a = _PROPERTY_VALIDATOR.validate("enabled", b.enabled, _PROPERTY_VALIDATOR.TYPE.BOOLEAN,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                if (a == null) {
                    a = true
                }
                if (b.triggers) {
                    c = _PROPERTY_VALIDATOR.validate("onClick", b.triggers.onClick, _PROPERTY_VALIDATOR.TYPE
                        .FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (b.onClick) {
                    c = _PROPERTY_VALIDATOR.validate("onClick", b.onClick, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
            }
            if (!b || !b.rotate) {
            ...
            this.__defineSetter__("enabled", function(e) {
                e = _PROPERTY_VALIDATOR.validate("enabled", e, _PROPERTY_VALIDATOR.TYPE.BOOLEAN,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                if (e == null) {
                    e = true
                }
            ...
            this.__defineSetter__("onClick", function(e) {
                e = _PROPERTY_VALIDATOR.validate("onClick", e, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                c = e;
                AR.i.callAsync({
                    objectId: this.__id,
    ...
    AR.DrawableRotate = PClass.create({
        init: function(d, c) {
            ...
            if (c) {
                if (c.roll) {
                    b = _PROPERTY_VALIDATOR.validate("rotate.roll", c.roll, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                        _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)
                }
                if (c.tilt) {
                    a = _PROPERTY_VALIDATOR.validate("rotate.tilt", c.tilt, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                        _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)
                }
                if (c.heading) {
                    e = _PROPERTY_VALIDATOR.validate("rotate.heading", c.heading, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                        _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)
                }
            }
            this.__defineSetter__("roll", function(g) {
                g = _PROPERTY_VALIDATOR.validate("rotate.roll", g, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                AR.i.callAsync({
                    objectId: f.__id,
                    is: "AR.i.drawableInterface.setRoll",
            ...
            this.__defineSetter__("tilt", function(g) {
                g = _PROPERTY_VALIDATOR.validate("rotate.tilt", g, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                AR.i.callAsync({
                    objectId: f.__id,
                    is: "AR.i.drawableInterface.setTilt",
            ...
            this.__defineSetter__("heading", function(g) {
                g = _PROPERTY_VALIDATOR.validate("rotate.heading", g, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                AR.i.callAsync({
                    objectId: f.__id,
                    is: "AR.i.drawableInterface.setHeading",
    ...
    AR.Drawable2D = AR.Drawable.extend({
        validateHorizontalAnchor: function(a) {
            if (!AR.CONST.HORIZONTAL_ANCHOR.isValidHorizontalAnchor(a)) {
                throw AR.ERROR.create("horizontalAnchor", AR.ERROR.TYPE.OBJECT, "HORIZONTAL_ANCHOR.___",
                    typeof a)
            }
            return a
        },
    ...
    AR.Model = AR.Drawable.extend({
        init: function(b, i) {
            ...
            var e = _PROPERTY_VALIDATOR.validate("uri", b, _PROPERTY_VALIDATOR.TYPE.STRING,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            var c, d;
            ...
            if (i) {
                if (i.onLoaded) {
                    c = _PROPERTY_VALIDATOR.validate("onLoaded", i.onLoaded, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (i.onError) {
                    d = _PROPERTY_VALIDATOR.validate("onError", i.onError, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
            }
            ...
            this.__defineSetter__("onLoaded", function(j) {
                j = _PROPERTY_VALIDATOR.validate("onLoaded", j, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                c = j;
                AR.i.callAsync({
                    objectId: this.__id,
            ...
            this.__defineSetter__("onError", function(j) {
                j = _PROPERTY_VALIDATOR.validate("onError", j, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                d = j;
                AR.i.callAsync({
                    objectId: this.__id,
    ...
    AR.ModelScale = PClass.create({
        init: function(e, d) {
            ...
            if (d) {
                if (d.x != null) {
                    c = _PROPERTY_VALIDATOR.validate("scale.x", d.x, _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (d.y != null) {
                    b = _PROPERTY_VALIDATOR.validate("scale.y", d.y, _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (d.z != null) {
                    a = _PROPERTY_VALIDATOR.validate("scale.z", d.z, _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
            }
            ...
            this.__defineSetter__("x", function(g) {
                c = _PROPERTY_VALIDATOR.validate("scale.x", g, _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                AR.i.callAsync({
                    objectId: f.__id,
                    scaleX: c,
            ...
            this.__defineSetter__("y", function(g) {
                b = _PROPERTY_VALIDATOR.validate("scale.y", g, _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                AR.i.callAsync({
                    objectId: f.__id,
                    scaleY: b,
            ...
            this.__defineSetter__("z", function(g) {
                a = _PROPERTY_VALIDATOR.validate("scale.z", g, _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                AR.i.callAsync({
                    objectId: f.__id,
                    scaleZ: a,
    ...
    AR.ModelTranslate = PClass.create({
        init: function(e, d) {
            ...
            if (d) {
                if (d.x) {
                    c = _PROPERTY_VALIDATOR.validate("translate.x", d.x, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                        _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)
                }
                if (d.y) {
                    b = _PROPERTY_VALIDATOR.validate("translate.y", d.y, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                        _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)
                }
                if (d.z) {
                    a = _PROPERTY_VALIDATOR.validate("translate.z", d.z, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                        _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)
                }
            }
            if (!f.__modelNotCreatedInCoreYet) {
            ...
            this.__defineSetter__("x", function(g) {
                g = _PROPERTY_VALIDATOR.validate("translate.x", g, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                AR.i.callAsync({
                    objectId: f.__id,
                    is: "AR.i.modelInterface.setTranslateX",
            ...
            this.__defineSetter__("y", function(g) {
                g = _PROPERTY_VALIDATOR.validate("translate.y", g, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                AR.i.callAsync({
                    objectId: f.__id,
                    is: "AR.i.modelInterface.setTranslateY",
            ...
            this.__defineSetter__("z", function(g) {
                g = _PROPERTY_VALIDATOR.validate("translate.z", g, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                AR.i.callAsync({
                    objectId: f.__id,
                    is: "AR.i.modelInterface.setTranslateZ",
    ...
    AR.HtmlDrawable = AR.Drawable2D.extend({
        init: function(m, k, d) {
            var o = function(s) {
                if (s.indexOf("<body") == -1) {
                    return "<html><head/><body style='background:transparent;margin:0;'>" + s +
                        "</body></html>"
                } else {
                    return s
                }
            ...
            a = _PROPERTY_VALIDATOR.validate("content.html", m.html, _PROPERTY_VALIDATOR.TYPE.STRING,
                _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
            i = _PROPERTY_VALIDATOR.validate("content.uri", m.uri, _PROPERTY_VALIDATOR.TYPE.STRING,
                _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
            var f = _PROPERTY_VALIDATOR.validate("width", k, _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            if (!a && !i) {
            ...
            if (d) {
                if (d.onLoaded) {
                    e = _PROPERTY_VALIDATOR.validate("onLoaded", d.onLoaded, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (d.onError) {
                    n = _PROPERTY_VALIDATOR.validate("onError", d.onError, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (d.viewportWidth) {
                    r = _PROPERTY_VALIDATOR.validate("viewportWidth", d.viewportWidth, _PROPERTY_VALIDATOR.TYPE
                        .POSITIVE_INT, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                    if (r > g) {
                        throw AR.ERROR.create("viewportWidth", AR.ERROR.TYPE.RANGE, "(0, " + g + "]")
                    }
                }
                if (d.backgroundColor) {
                    l = _PROPERTY_VALIDATOR.validate("backgroundColor", d.backgroundColor,
                        _PROPERTY_VALIDATOR.TYPE.RGBA, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (d.updateRate) {
                    if (!AR.HtmlDrawable.UPDATE_RATE.isValidUpdateRate(d.updateRate)) {
                        throw AR.ERROR.create("updateRate", AR.ERROR.TYPE.ENUMERATION,
                ...
                if (d.clickThroughEnabled) {
                    q = _PROPERTY_VALIDATOR.validate("clickThroughEnabled", d.clickThroughEnabled,
                        _PROPERTY_VALIDATOR.TYPE.BOOLEAN, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (d.allowDocumentLocationChanges) {
                    p = _PROPERTY_VALIDATOR.validate("allowDocumentLocationChanges", d.allowDocumentLocationChanges,
                        _PROPERTY_VALIDATOR.TYPE.BOOLEAN, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (d.onDocumentLocationChanged) {
                    b = _PROPERTY_VALIDATOR.validate("onDocumentLocationChanged", d.onDocumentLocationChanged,
                        _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
            }
            if (i) {
            ...
            this.__defineSetter__("html", function(s) {
                s = _PROPERTY_VALIDATOR.validate("html", s, _PROPERTY_VALIDATOR.TYPE.STRING,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                s = o(s);
                AR.i.callAsync({
            ...
            this.__defineSetter__("uri", function(s) {
                s = _PROPERTY_VALIDATOR.validate("uri", s, _PROPERTY_VALIDATOR.TYPE.STRING,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                if (s) {
            ...
            this.__defineSetter__("backgroundColor", function(s) {
                s = _PROPERTY_VALIDATOR.validate("backgroundColor", s, _PROPERTY_VALIDATOR.TYPE.RGBA,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                AR.i.callAsync({
            ...
            this.__defineSetter__("width", function(s) {
                s = _PROPERTY_VALIDATOR.validate("width", s, _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                AR.i.callAsync({
            ...
            this.__defineSetter__("viewportWidth", function(s) {
                s = _PROPERTY_VALIDATOR.validate("viewportWidth", s, _PROPERTY_VALIDATOR.TYPE.POSITIVE_INT,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                if (s > g) {
                    throw AR.ERROR.create("viewportWidth", AR.ERROR.TYPE.RANGE, "(0, " + g + "]")
                }
            ...
            this.__defineSetter__("updateRate", function(s) {
                s = _PROPERTY_VALIDATOR.validate("updateRate", s, _PROPERTY_VALIDATOR.TYPE.INT,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            ...
            this.__defineSetter__("clickThroughEnabled", function(s) {
                s = _PROPERTY_VALIDATOR.validate("clickThroughEnabled", s, _PROPERTY_VALIDATOR.TYPE
                    .BOOLEAN, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                AR.i.callAsync({
            ...
            this.__defineSetter__("allowDocumentLocationChanges", function(s) {
                s = _PROPERTY_VALIDATOR.validate("allowDocumentLocationChanges", s,
                    _PROPERTY_VALIDATOR.TYPE.BOOLEAN, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                AR.i.callAsync({
            ...
            this.__defineSetter__("onDocumentLocationChanged", function(s) {
                s = _PROPERTY_VALIDATOR.validate("onDocumentLocationChanged", s,
                    _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                b = s;
                AR.i.callAsync({
            ...
            this.__defineSetter__("onLoaded", function(s) {
                s = _PROPERTY_VALIDATOR.validate("onLoaded", s, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                e = s;
                AR.i.callAsync({
            ...
            this.__defineSetter__("onError", function(s) {
                s = _PROPERTY_VALIDATOR.validate("onError", s, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                n = s;
                AR.i.callAsync({
        ...
        evalJavaScript: function(a) {
            _PROPERTY_VALIDATOR.validate("js", a, _PROPERTY_VALIDATOR.TYPE.STRING, _PROPERTY_VALIDATOR.RULE
                .MUST_BE_SET);
            AR.i.callAsync({
    ...
    AR.ImageDrawable = AR.Drawable2D.extend({
        init: function(f, a, b) {
            ...
            var d = _PROPERTY_VALIDATOR.validate("height", a, _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            ...
            this.__defineSetter__("height", function(h) {
                h = _PROPERTY_VALIDATOR.validate("height", h, _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                AR.i.callAsync({
    ...
    AR.AnimatedImageDrawable = AR.ImageDrawable.extend({
        init: function(f, j, i, c, k) {
            var a = _PROPERTY_VALIDATOR.validate("keyFrameWidth", i, _PROPERTY_VALIDATOR.TYPE.POSITIVE_INT,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            var d = _PROPERTY_VALIDATOR.validate("keyFrameHeight", c, _PROPERTY_VALIDATOR.TYPE.POSITIVE_INT,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            var h = 0;
            var e;
            if (k) {
                if (k.keyFrame) {
                    h = _PROPERTY_VALIDATOR.validate("keyFrame", k.keyFrame, _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE_INT,
                        _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)
                }
                if (k.onFinish) {
                    e = _PROPERTY_VALIDATOR.validate("onFinish", k.onFinish, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
            }
            if (!k) {
            ...
            this.__defineSetter__("onFinish", function(l) {
                l = _PROPERTY_VALIDATOR.validate("onFinish", l, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                e = l;
                AR.i.callAsync({
        ...
        setKeyFrame: function(a) {
            var b = _PROPERTY_VALIDATOR.validate("keyFramePos", a, _PROPERTY_VALIDATOR.TYPE.INT,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            AR.i.callAsync({
                objectId: this.__id,
        ...
        animate: function(c, e, b) {
            ...
            var f = _PROPERTY_VALIDATOR.validate("duration", e, _PROPERTY_VALIDATOR.TYPE.POSITIVE_INT,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            var a = 1;
            if (b) {
                a = _PROPERTY_VALIDATOR.validate("loopTimes", b, _PROPERTY_VALIDATOR.TYPE.INT,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)
            }
            AR.i.callAsync({
                objectId: this.__id,
    ...
    AR.RelativeLocation = AR.Location.extend({
        init: function(g, a, e, c) {
            ...
            var b = _PROPERTY_VALIDATOR.validate("northing", a, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            var d = _PROPERTY_VALIDATOR.validate("easting", e, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            var i = _PROPERTY_VALIDATOR.validate("altitudeDelta", c, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
            if (!i) {
                i = 0
            }
            ...
            this.__defineSetter__("northing", function(j) {
                j = _PROPERTY_VALIDATOR.validate("northing", j, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                AR.i.callAsync({
            ...
            this.__defineSetter__("easting", function(j) {
                j = _PROPERTY_VALIDATOR.validate("easting", j, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                AR.i.callAsync({
            ...
            this.__defineSetter__("altitudeDelta", function(j) {
                j = _PROPERTY_VALIDATOR.validate("altitudeDelta", j, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                if (!j) {
                    j = 0
                }
    ...
    AR.ImageResource = AR.ARchitectObject.extend({
        init: function(d, b) {
            this._super();
            AR.logger.error('test ImageResource ' + d);
            var f = this.validateUri(d);
            AR.logger.error('test2 ImageResource ' + f);
            var e, a;
            if (b != null) {
                if (b.onLoaded != null) {
    ...
    AR.Animation = AR.ARchitectObject.extend({
        init: function(a) {
            ...
            var b = null;
            if (a != null) {
                c = _PROPERTY_VALIDATOR.validate("onStart", a.onStart, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                b = _PROPERTY_VALIDATOR.validate("onFinish", a.onFinish, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
            }
            this.__defineSetter__("onStart", function(d) {
                d = _PROPERTY_VALIDATOR.validate("onStart", d, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                c = d;
                AR.i.callAsync({
                    objectId: this.__id,
            ...
            this.__defineSetter__("onFinish", function(d) {
                d = _PROPERTY_VALIDATOR.validate("onFinish", d, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                b = d;
                AR.i.callAsync({
                    objectId: this.__id,
        ...
        start: function(a) {
            a = _PROPERTY_VALIDATOR.validate("loopTimes", a, _PROPERTY_VALIDATOR.TYPE.INT,
                _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
            if (!a && a != 0) {
                a = 1
            }
    ...
    AR.PropertyAnimation = AR.Animation.extend({
        init: function(s, j, g, e, a, p, d) {
            ...
            var n = _PROPERTY_VALIDATOR.validate("property", j, _PROPERTY_VALIDATOR.TYPE.STRING,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            var b = m;
            var h = n.split(".");
            ...
            var r = _PROPERTY_VALIDATOR.validate("start", g, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
            if (r != null && r != undefined) {
                r = "[" + r + "]"
            }
            var l = "[" + _PROPERTY_VALIDATOR.validate("end", e, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET) + "]";
            var f = _PROPERTY_VALIDATOR.validate("duration", a, _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            if (!p || !(p.type)) {
                p = {
        ...
        validateEasingCurve: function(a) {
            ...
            if (!AR.CONST.EASING_CURVE_TYPE.isValidEasingCurveType(a.type)) {
                throw AR.ERROR.create("easingCurve.type", AR.ERROR.TYPE.ENUMERATION,
    ...
    AR.OneTimeUseContextConstructionPlan = PClass.create({
        ...
        init: function() {
            ...
            this.__defineSetter__("clickBehavior", function(f) {
                if (f != AR.CONST.CLICK_BEHAVIOR.CLICK && f != AR.CONST.CLICK_BEHAVIOR.TOUCH_UP &&
                    f != AR.CONST.CLICK_BEHAVIOR.TOUCH_DOWN) {
                    throw AR.ERROR.create("clickBehavior", AR.ERROR.TYPE.OBJECT,
            ...
            var b = function() {
                ...
                this.__defineSetter__("camera", function(h) {
                    h = _PROPERTY_VALIDATOR.validate("services.camera", h, _PROPERTY_VALIDATOR.TYPE
                        .BOOLEAN, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                    g = h;
                    AR.i.callAsync({
                ...
                this.__defineSetter__("sensors", function(h) {
                    h = _PROPERTY_VALIDATOR.validate("services.sensors", h, _PROPERTY_VALIDATOR
                        .TYPE.BOOLEAN, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                    f = h;
                    AR.i.callAsync({
                        is: "AR.i.contextInterface.setServiceEnabled",
                        service: "sensors",
            ...
            var e = function() {
                ...
                this.__defineSetter__("cullingDistance", function(g) {
                    g = _PROPERTY_VALIDATOR.validate("scene.cullingDistance", g,
                        _PROPERTY_VALIDATOR.TYPE.POSITIVE_INT, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET
                    );
                    f = g;
                    AR.i.callAsync({
    ...
    AR.Tracker = AR.ARchitectObject.extend({
        init: function(g, c) {
            this._super();
            var h = _PROPERTY_VALIDATOR.validate("src", g, _PROPERTY_VALIDATOR.TYPE.STRING,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            var a = true;
            var e;
            var f;
            ...
            if (c) {
                if (c.enabled) {
                    a = _PROPERTY_VALIDATOR.validate("enabled", c.enabled, _PROPERTY_VALIDATOR.TYPE.BOOLEAN,
                        _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)
                }
                if (c.onDisabled) {
                    e = _PROPERTY_VALIDATOR.validate("onDisabled", c.onDisabled, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (c.onLoaded) {
                    f = _PROPERTY_VALIDATOR.validate("onLoaded", c.onLoaded, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (c.onError) {
                    b = _PROPERTY_VALIDATOR.validate("onError", c.onError, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
            }
            var d = AR.om.createObjectID();
            ...
            this.__defineSetter__("enabled", function(i) {
                i = _PROPERTY_VALIDATOR.validate("enabled", i, _PROPERTY_VALIDATOR.TYPE.BOOLEAN,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                AR.i.callAsync({
                    objectId: d,
            ...
            this.__defineSetter__("onDisabled", function(i) {
                i = _PROPERTY_VALIDATOR.validate("onDisabled", i, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                e = i;
                AR.i.callAsync({
                    objectId: d,
            ...
            this.__defineSetter__("onLoaded", function(i) {
                i = _PROPERTY_VALIDATOR.validate("onLoaded", i, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                f = i;
                AR.i.callAsync({
                    objectId: d,
            ...
            this.__defineSetter__("onError", function(i) {
                i = _PROPERTY_VALIDATOR.validate("onError", i, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                b = i;
                AR.i.callAsync({
                    objectId: d,
    ...
    AR.Trackable2DObject = AR.ARObject.extend({
        init: function(f, e, c) {
            ...
            var a = _PROPERTY_VALIDATOR.validate("targetName", e, _PROPERTY_VALIDATOR.TYPE.STRING,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            var d = AR.om.createObjectID();
            AR.i.callAsync({
                objectId: d,
    ...
    AR.OneTimeUseRadarConstructionPlan = PClass.create({
        init: function() {
            ...
            this.__defineSetter__("enabled", function(l) {
                l = _PROPERTY_VALIDATOR.validate("enabled", l, _PROPERTY_VALIDATOR.TYPE.BOOLEAN,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                f = l;
                AR.i.callAsync({
            ...
            this.__defineSetter__("positionX", function(l) {
                l = _PROPERTY_VALIDATOR.validate("positionX", l, _PROPERTY_VALIDATOR.TYPE.UNIT_INTERVAL,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                j = l;
                AR.i.callAsync({
            ...
            this.__defineSetter__("positionY", function(l) {
                l = _PROPERTY_VALIDATOR.validate("positionY", l, _PROPERTY_VALIDATOR.TYPE.UNIT_INTERVAL,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                i = l;
                AR.i.callAsync({
            ...
            this.__defineSetter__("width", function(l) {
                l = _PROPERTY_VALIDATOR.validate("width", l, _PROPERTY_VALIDATOR.TYPE.UNIT_INTERVAL,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                e = l;
                AR.i.callAsync({
            ...
            this.__defineSetter__("centerX", function(l) {
                l = _PROPERTY_VALIDATOR.validate("centerX", l, _PROPERTY_VALIDATOR.TYPE.UNIT_INTERVAL,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                d = l;
                AR.i.callAsync({
            ...
            this.__defineSetter__("centerY", function(l) {
                l = _PROPERTY_VALIDATOR.validate("centerY", l, _PROPERTY_VALIDATOR.TYPE.UNIT_INTERVAL,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                c = l;
                AR.i.callAsync({
            ...
            this.__defineSetter__("radius", function(l) {
                l = _PROPERTY_VALIDATOR.validate("radius", l, _PROPERTY_VALIDATOR.TYPE.UNIT_INTERVAL,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                a = l;
                AR.i.callAsync({
            ...
            this.__defineSetter__("maxDistance", function(l) {
                l = _PROPERTY_VALIDATOR.validate("maxDistance", l, _PROPERTY_VALIDATOR.TYPE.POSITIVE,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                k = l;
                AR.i.callAsync({
            ...
            this.__defineSetter__("onClick", function(l) {
                l = _PROPERTY_VALIDATOR.validate("onClick", l, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                g = l;
                AR.i.callAsync({
    ...
    AR._NorthIndicator = PClass.create({
        init: function() {
            ...
            this.__defineSetter__("radius", function(c) {
                c = _PROPERTY_VALIDATOR.validate("northIndicator.radius", c, _PROPERTY_VALIDATOR.TYPE
                    .UNIT_INTERVAL, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                a = c;
                AR.i.callAsync({
    ...
    printStackTrace.implementation.prototype = {
        ...
        opera: function(h) {
            ...
            for (f = 4, d = 0, a = c.length; f < a; f += 2) {
                if (g.test(c[f])) {
                    c[d++] = (RegExp.$3 ? RegExp.$3 + "()@" + RegExp.$2 + RegExp.$1 : b + "()@" + RegExp.$2 +
                        ":" + RegExp.$1) + " -- " + c[f + 1].replace(/^\s+/, "")
                }
            }
                        ...
                        if (a.constructor) {
                            if (a.constructor === Array) {
                                if (a.length < 3) {
                                    ...
                                    b[c] = "[" + this.stringifyArguments(Array.prototype.slice.call(a, 0, 1)) +
                                        "..." + this.stringifyArguments(Array.prototype.slice.call(a, -1)) +
                                        "]"
                                }
                            } else {
    ...
    AR.ADE.Screen = function() {
        ...
        var f = function() {
            ...
            var q = function(G) {
                ...
                window.setTimeout("document.getElementById('" + G + "').style.backgroundColor = 'white';",
                    1000)
            };
    ...
    AR.ADE.ConstructionPlan = function() {
        ...
        this.applyLocationUncertainity = function() {
            if (AR.ADE.instance.simulateLocation) {
                ...
                if (AR.context.onLocationChanged) {
                    AR.context.onLocationChanged(this.simulatedLocation.latitude, this.simulatedLocation.longitude,
                        this.simulatedLocation.altitude, this.simulatedLocation.accuracy)
                }
            }
        };
        ...
        this.applyLocationUpdate = function(f) {
            ...
            if (AR.context.onLocationChanged != null) {
                AR.context.onLocationChanged(AR.ADE.instance.simulatedLocation.latitude, AR.ADE.instance.simulatedLocation
                    .longitude, AR.ADE.instance.simulatedLocation.altitude, AR.ADE.instance.simulatedLocation
                    .accuracy)
            }
        };
        var c = function() {
    ...
    AR.ADE.Tree = function(b) {
        ...
        var d = function(s, o, r, p) {
            ...
            var n = function(u, t) {
                return "javascript:AR.ADE.instance.trigger('" + u + "','" + t.trigger + "'" + (t.parameters ?
    ...
    AR.i.locationInterface = {
        ...
        distanceToUser: function(c) {
            if (AR.ADE.instance.simulatedLocation) {
                ...
                var d = b.latitude;
                var a = b.longitude;
                return AR.i.locationInterface.calculateDistance(d, AR.ADE.instance.simulatedLocation.latitude,
                    a, AR.ADE.instance.simulatedLocation.longitude)
            }
            return -1
        },
        calculateDistance: function(i, h, g, f) {
            ...
            var b = Math.sin(d / 2) * Math.sin(d / 2) + Math.cos(i * Math.PI / 180) * Math.cos(h * Math.PI /
                180) * Math.sin(e / 2) * Math.sin(e / 2);
                ...
                explain: function() {
                    return {
                        ...
                        properties: {
                            latitude: this._latitude,
                            longitude: this._longitude,
                            altitude: (this._altitude == AR.CONST.UNKNOWN_ALTITUDE ?
                                "AR.CONST.UNKNOWN_ALTITUDE" : this._altitude)
                        }
                    }
                }
            });
    ...
    AR.i.relativeLocationInterface = {
        ...
        createRelativeLocation: function(a) {
            AR.i.registerBridgeObject({
                ...
                getCurrentLocation: function() {
                    ...
                    var c = AR.i.relativeLocationInterface.calculateNewLocation(d.latitude, d.longitude,
                        d.altitude, a.northing, a.easting, a.altitudeDelta);
                    return {
                        latitude: c.latitude,
        ...
        createRelativeLocationToUser: function(b) {
            var a = AR.i.relativeLocationInterface.calculateNewLocation(AR.ADE.instance.simulatedLocation.latitude,
                AR.ADE.instance.simulatedLocation.longitude, AR.ADE.instance.simulatedLocation.altitude, b.northing,
                b.easting, b.altitudeDelta);
            AR.i.registerBridgeObject({
                _id: b.objectId,
        ...
        calculateNewLocation: function(k, a, h, b, g, c) {
            ...
            i = i + Math.atan2(Math.sin(f) * Math.sin(j) * Math.cos(e), Math.cos(j) - Math.sin(e) * Math.sin(
                lat2));
            e = lat2;
            return {
    ...
    AR.i.actionRangeInterface = {
        ...
        isInArea: function(b, a) {
            return (AR.om.getExistingObjectForID(b).location.distanceTo(AR.om.getExistingObjectForID(a)) <= AR.i
                .getBridgeObject(b)._radius)
        }
    };
                ...
                explain: function() {
                    return {
                        ...
                        properties: {
                            ...
                            start: (this._start == null ? null : AR.__fromJSONString__(this._start)[
                                0]),
